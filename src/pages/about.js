      ...
      <section className="about">
        ...
        <div className="flex-space-between">
          ...
          <div className="about-hero-flex-2">
            <p className="large">
              Hi, I’m Hana.
              <br /> I'm a freelance web and Shopify developer who loves to help
              people with their businesses.
            </p>
            <br />

            <p>
              I create easy to use, beautiful websites that convert visitors
              into customers. First impressions are everything when it comes to
              websites. I want to help you make a good one!
            </p>
            <br />

            <p>
              When I'm not typing away at my laptop, I am out in nature,
              exploring the city with bubble tea in hand, or petting cats.
            </p>
            <br />

            <p>
              Join my Facebook community group,{" "}
              <a
              ...
              , to collaborate with women in e-commerce.
            </p>
          </div>
        </div>
      </section>
        ...
        >
          <div className="carousel-cell">
            <p className="quote">
              ...
              She showed great flexibility and was very efficient in
              communicating with me throughout. I very much appreciated Hana's
              integrity. Even though we are worlds apart - I am in England, she
              is in Canada - she made Canada feel closer! Thank you so much,
              Hana. I enjoyed our work together and{" "}
              <span className="highlight hl-yellow">
            ...
            <div className="flex-quote">
              ...
              <div>
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  www.senseofselfcounselling.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="carousel-cell">
            <p className="quote">
              ...
              the lines of communication open throughout the project even though
              we were in different time zones! She had a clear vision for the
              layout and design and created a piece of art! She was{" "}
              <span className="highlight hl-blue">very professional</span> and
              quickly made any changes that were needed. I highly recommend
              Hana!{" "}
              <span className="highlight hl-blue">
                I finally have a website I can be proud of!
              </span>
            </p>
            <div className="flex-quote">
              <div>
              ...
              <div>
                ...
                <a
                  href="https://simplypureskinstudio.com/"
                  target="_blank"
                  rel="noreferrer"
                >
                  www.simplypureskinstudio.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="carousel-cell">
            <p className="quote">
              It was a pleasure working with Hana. She quickly{" "}
              <span className="highlight hl-purple">
                understood my design preferences
              </span>{" "}
              and was able to implement my feedback so that each step of the
              website build became easier and faster. She showed{" "}
              <span className="highlight hl-purple">
                true dedication to the project
              </span>{" "}
              by building custom sections so that the{" "}
              <span className="highlight hl-purple">
                layout was professional and interesting.
              </span>{" "}
              She had great communication throughout the project even though we
              were in different time zones and delivered on schedule. I would
            ...
            <div className="flex-quote">
              ...
              <div>
                <p>
                  Katrina Walker, <em>CEO & Founder at CodeOp</em>
                </p>
                <a href="https://codeop.tech/" target="_blank" rel="noreferrer">
                  www.codeop.tech
                </a>
              </div>
            </div>
